USE Operacion
GO
-- DROP FUNCTION OpeSch.OpeConsultaRemisionVentaFn
GO
ALTER FUNCTION OpeSch.OpeConsultaRemisionEstimacionFn
(
	  @pnFabricacionEstimacion	INT
	, @pdIdViajeEstimacion		INT
	, @pnClaUbicacionEstimacion	INT
)
RETURNS VARCHAR(20)
AS
BEGIN
	DECLARE @tbPedidosEstimaciones TABLE(
	...
	DECLARE @sRemision VARCHAR(20)

	INSERT INTO @tbPedidosEstimaciones (
		  IdFabriacionUnificado		, ClaUbicacionVenta			
		, idFabricacionVenta		, ClaUbicacionEstimacion	
		, idFabricacionEstimacion		
	)
	SELECT	  a.IdFabriacionUnificado
			, @pnClaUbicacionEstimacion	AS ClaUbicacionVenta
	...
	SELECT--a.ClaUbicacionVenta, a.idFabricacionVenta, ir.IdViaje AS ViajeVenta, a.ClaUbicacionEstimacion, a.idFabricacionEstimacion, ie.IdViaje AS ViajeEstimacion,
			@sRemision = fr.IdFacturaAlfanumerico
	FROM	@tbPedidosEstimaciones a 
