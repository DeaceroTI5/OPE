...
<script type="text/javascript"> 
 var controlesRequeridos_ConfirmarDocumento = ["<%= ClaTipoDocumentoMod.ClientID%>|1","<%= Documento.ClientID%>|1"]; 
 var controlesRequeridos_GuardaDoc = ["<%= ClaTipoDocumentoMod.ClientID%>|1","<%= Documento.ClientID%>|1"]; 
...
<asp:UpdatePanel ID="uDocumento" IsIgnored="true" runat="server" UpdateMode="Conditional">	<ContentTemplate> <cc1:WebFileUpload ID="Documento" IsFilter="true" IsIgnored="true" runat="server" width="230.000px" Visible="true" Enabled="true" NeedsValueChange="false" > </cc1:WebFileUpload> </ContentTemplate></asp:UpdatePanel></div>
