...
public partial class OPE_CU550_Pag30 : BasePage
{
 ...
 protected void grid_ValueChange(object sender, WebGridValueChangeArgs e)
 {
  ...
  // Tipo 2.- Apertura de una Pantalla Modal.   Validacion :EsNuevoDoc= 0, IdViajeMod=IdViajeAux, PlacasMod=PlacasAux, ClaFabricacionMod = IdFabricacionAux, IdDocumentoMod = IdDocumentoAux , ClaTipoDocumentoMod = ClaTipoDocumentoAux, NumDocumentoMod =NumDocumentoAux, @@FILTRAMODAL_ModalDoc,@@MODAL_ModalDoc, @@EDIT__EditDoc, @@VISIBLE__ReemplazarDoc, @@VISIBLE__NuevoDoc, @@VISIBLE_AceptarDoc
   ...
   AsignarValorAut("ClaFabricacionMod", ObtenerValor("IdFabricacionAux") );
   AsignarValorAut("IdDocumentoMod", ObtenerValor("IdDocumentoAux") );
   AsignarValorAut("ClaTipoDocumentoMod", ObtenerValor("ClaTipoDocumentoAux") );
   AsignarValorAut("NumDocumentoMod", ObtenerValor("NumDocumentoAux") );
 ...
 protected void control_Click(object obj, EventArgs Args)
 {
  ...
  // Tipo 2.- Apertura de una Pantalla Modal.   Validacion :@@imagen_attach24.png, EsNuevoDoc= 1, IdViajeMod=IdViajeAux, PlacasMod=PlacasAux , ClaFabricacionMod = NULL, ClaTipoDocumentoMod = NULL, NumDocumentoMod=NULL , @@FILTRAMODAL_ModalDoc,@@MODAL_ModalDoc, @@EDIT_EditDoc, @@VISIBLE_ReemplazarDoc, @@VISIBLE_NuevoDoc, @@VISIBLE__AceptarDoc
  ...
  // Tipo 6.- Ejecucion de un proceso en SQL.   Validacion :@@REQ_ClaTipoDocumentoMod_Documento, @@PROCR,,@@SInQueacer
   // Ejecuto el proceso del back);
        DataSet ds10;
  ...
  // Tipo 4.- Cierre de una modal.   Validacion :@@REQ_ClaTipoDocumentoMod_Documento, @@GRABAMODAL_ModalDoc, @@RETORNO, @@FILTRAGRID_InfoDocumento
