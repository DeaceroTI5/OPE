-- Objeto:		OPESch.OPE_CU444_Pag32_Grid_ConsultaModCR_IU
-- Autor:
-- Fecha:
-- Objetivo:
-- Entrada:
...
-- Revisiones:
--*----
CREATE PROCEDURE OpeSch.OPE_CU444_Pag32_Grid_ConsultaModCR_IU
@pnClaUbicacion INT,
...
BEGIN
	...
	BEGIN
		...
		EXEC	OPESch.OPE_CU444_Pag32_Boton_CreaPlanDet_Proc
