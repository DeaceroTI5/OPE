/*
select *   FROM OpeSch.OpeTraConexionRemota WITH(NOLOCK)  where clasistema  = 1990
insert into  OpeSch.OpeTraConexionRemota  values  (55,	1990, 	'[DEAOFINET05].Ventas.vtasch'	, 1270000	, getdate() , 'CARGA INICIAL','VTA5' )
*/
