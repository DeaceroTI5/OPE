USE Operacion
GO
-- EXEC SP_HELPTEXT 'OpcSch.OPCCrearPdfCertTipo2Proc'
GO
ALTER PROCEDURE OpcSch.OPCCrearPdfCertTipo2Proc
@pnNumVersion		INT,
@pnClaUbicacion		INT,
@pnIdCertificado	INT,
...
BEGIN
	...
	IF ISNULL(@psRutaProcedimiento, '') = ''
		SELECT @psRutaProcedimiento = 'OpcSch.OPCCrearPdfCertTipo2Proc'
    ELSE
		SELECT @psRutaProcedimiento = LTRIM(RTRIM(@psRutaProcedimiento)) + ' - ' + 'OpcSch.OPCCrearPdfCertTipo2Proc'
   ...
   SELECT @sNomArticulo = replace(replace(replace(replace(replace(replace(replace(replace(replace(replace(replace(replace(replace(replace(replace(replace(@sNomArticulo, 
	...
	SET @sComandoDinamico = 'echo 	parameters(5).Name = "psNombreCliente"												>> "'+@sNomArchivoRSS+'"'
	EXEC master.dbo.xp_cmdshell @sComandoDinamico, no_output
	
	SET @sComandoDinamico = 'echo 	parameters(5).Value = "' + @sNombreCliente + '"						>> "'+@sNomArchivoRSS+'"'
	EXEC master.dbo.xp_cmdshell @sComandoDinamico, no_output
 
	SET @sComandoDinamico = 'echo 	parameters(6) = New ParameterValue()												>> "'+@sNomArchivoRSS+'"'
	EXEC master.dbo.xp_cmdshell @sComandoDinamico, no_output
	
	SET @sComandoDinamico = 'echo 	parameters(6).Name = "pnCantidad"													>> "'+@sNomArchivoRSS+'"'
	EXEC master.dbo.xp_cmdshell @sComandoDinamico, no_output
	
	SET @sComandoDinamico = 'echo 	parameters(6).Value = "'+CONVERT(VARCHAR,CONVERT(INT,ISNULL(@nKgsTotal,0)))+'"							>> "'+@sNomArchivoRSS+'"'
	EXEC master.dbo.xp_cmdshell @sComandoDinamico, no_output	
	
	SET @sComandoDinamico = 'echo 	parameters(7) = New ParameterValue()												>> "'+@sNomArchivoRSS+'"'
	EXEC master.dbo.xp_cmdshell @sComandoDinamico, no_output
	
	SET @sComandoDinamico = 'echo 	parameters(7).Name = "psNomUnidad"													>> "'+@sNomArchivoRSS+'"'
	EXEC master.dbo.xp_cmdshell @sComandoDinamico, no_output
	
	SET @sComandoDinamico = 'echo 	parameters(7).Value = "' + @sNomUnidad + '"							>> "'+@sNomArchivoRSS+'"'
	EXEC master.dbo.xp_cmdshell @sComandoDinamico, no_output
 
	SET @sComandoDinamico = 'echo 	parameters(8) = New ParameterValue()												>> "'+@sNomArchivoRSS+'"'
	EXEC master.dbo.xp_cmdshell @sComandoDinamico, no_output
	
	SET @sComandoDinamico = 'echo 	parameters(8).Name = "psFactura"												>> "'+@sNomArchivoRSS+'"'
	EXEC master.dbo.xp_cmdshell @sComandoDinamico, no_output
	
	SET @sComandoDinamico = 'echo 	parameters(8).Value = "' + @sNumeroFactura +'"						>> "'+@sNomArchivoRSS+'"'
	EXEC master.dbo.xp_cmdshell @sComandoDinamico, no_output
		
	SET @sComandoDinamico = 'echo 	parameters(9) = New ParameterValue()												>> "'+@sNomArchivoRSS+'"'
	EXEC master.dbo.xp_cmdshell @sComandoDinamico, no_output
	
	SET @sComandoDinamico = 'echo 	parameters(9).Name = "pnIdOpm"													>> "'+@sNomArchivoRSS+'"'
	EXEC master.dbo.xp_cmdshell @sComandoDinamico, no_output
	
	SET @sComandoDinamico = 'echo 	parameters(9).Value = "' + CONVERT(VARCHAR,@nIdOpm) + '"														>> "'+@sNomArchivoRSS+'"'
	EXEC master.dbo.xp_cmdshell @sComandoDinamico, no_output
 
	SET @sComandoDinamico = 'echo 	parameters(10) = New ParameterValue()												>> "'+@sNomArchivoRSS+'"'
	EXEC master.dbo.xp_cmdshell @sComandoDinamico, no_output
	
	SET @sComandoDinamico = 'echo 	parameters(10).Name = "psClaveRollo"													>> "'+@sNomArchivoRSS+'"'
	EXEC master.dbo.xp_cmdshell @sComandoDinamico, no_output
	
	SET @sComandoDinamico = 'echo 	parameters(10).Value = "' + ISNULL(@psRollos,' ') + '"														>> "'+@sNomArchivoRSS+'"'
	EXEC master.dbo.xp_cmdshell @sComandoDinamico, no_output
