USE Operacion
GO
-- 'OpeSch.OpeImpresionCertMultiPiePrimoSel'
GO
ALTER PROCEDURE OpeSch.OpeImpresionCertMultiPiePrimoSel
	@pnClaUbicacion			INT,
...
BEGIN
	...
	EXEC OpeSch.OpeObtieneConfiguracionCertificadosOtUbic
		 @pnClaUbicacionOrigen	= @pnClaUbicacion--Origen
	...
	*/
	...
	FROM	OPMSch.TiCatUbicacionVw U WITH (NOLOCK),
			@tResult res
	WHERE	U.ClaUbicacion = @pnClaUbicacion--Origen
